        ...
        <nav class="navbar navbar-expand">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <div class="row row-cols-3 g-3 p-3">
                                <div class="col text-center">
                                    ...
                                    <div class="app-title">Superusers</div>
                                </div>
                                <div class="col text-center">
                                ...
                                <div class="col text-center">
                                    ...
                                    <div class="app-title">Offices</div>
                                </div>
                                <div class="col text-center">
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        <div class="user-online">
                                            <img src="{{ asset('assets/images/avatars/avatar-2.jpg') }}" class="msg-avatar" alt="user avatar">
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="msg-name">New Visitor <span class="msg-time float-end">5 sec
                                                    ago</span></h6>
                                            <p class="msg-info">A visitor has just checked in</p>
                                        </div>
                                    </div>
                                </a>
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="msg-name">Checkout <span class="msg-time float-end">14
                                                    sec ago</span></h6>
                                            <p class="msg-info">A guest has checked out</p>
                                        </div>
                                    </div>
                                </a>
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="msg-name">Exceeded time <span class="msg-time float-end">5 days
                                                    ago</span></h6>
                                            <p class="msg-info">Newton Muraya has overstayed his visit</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset('assets/images/avatars/avatar-2.jpg') }}" class="user-img" alt="user avatar">
